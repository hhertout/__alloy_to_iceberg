...
class TestGetPreviousDayRange:
    ...
    def test_returns_previous_day_midnight_to_end(self) -> None:
        ...
        now = datetime(2026, 3, 2, 14, 30, 0, tzinfo=timezone.utc)
        from_ts, to_ts = get_previous_day_range(now)

        expected_start = datetime(2026, 3, 1, 0, 0, 0, tzinfo=timezone.utc)
        expected_end = datetime(2026, 3, 1, 23, 59, 59, tzinfo=timezone.utc)
    ...
    def test_at_midnight_returns_previous_day(self) -> None:
        ...
        now = datetime(2026, 5, 10, 0, 0, 0, tzinfo=timezone.utc)
        from_ts, to_ts = get_previous_day_range(now)

        expected_start = datetime(2026, 5, 9, 0, 0, 0, tzinfo=timezone.utc)
        expected_end = datetime(2026, 5, 9, 23, 59, 59, tzinfo=timezone.utc)
    ...
    def test_at_end_of_day(self) -> None:
        ...
        now = datetime(2026, 7, 15, 23, 59, 59, tzinfo=timezone.utc)
        from_ts, to_ts = get_previous_day_range(now)

        expected_start = datetime(2026, 7, 14, 0, 0, 0, tzinfo=timezone.utc)
        expected_end = datetime(2026, 7, 14, 23, 59, 59, tzinfo=timezone.utc)
    ...
    def test_cross_month_boundary(self) -> None:
        ...
        expected_start = datetime(2026, 3, 31, 0, 0, 0, tzinfo=timezone.utc)
    ...
    def test_cross_year_boundary(self) -> None:
        ...
        expected_start = datetime(2025, 12, 31, 0, 0, 0, tzinfo=timezone.utc)
        expected_end = datetime(2025, 12, 31, 23, 59, 59, tzinfo=timezone.utc)
    ...
    def test_leap_year(self) -> None:
        ...
        now = datetime(2028, 3, 1, 6, 0, 0, tzinfo=timezone.utc)
        from_ts, to_ts = get_previous_day_range(now)

        expected_start = datetime(2028, 2, 29, 0, 0, 0, tzinfo=timezone.utc)
        expected_end = datetime(2028, 2, 29, 23, 59, 59, tzinfo=timezone.utc)
    ...
    def test_from_before_to(self) -> None:
        ...
        now = datetime(2026, 8, 20, 3, 15, 0, tzinfo=timezone.utc)
        from_ts, to_ts = get_previous_day_range(now)
